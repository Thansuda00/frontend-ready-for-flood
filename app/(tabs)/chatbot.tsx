...
const MOCK_ANSWERS: Record<string, string> = {
  "ระดับน้ำอยู่ในระดับไหนถึงจะต้องเตรียมยกของขึ้นที่สูง?": `
          -ระดับแม่น้ำกกสะพานพ่อขุนเม็งรายมหาราช เกณฑ์เฝ้าระวัง อยู่ที่ 5.50 ม. ครับ
          -ระดับแม่น้ำกกสะพานขัวพญาเม็งราย เกณฑ์เฝ้าระวัง อยู่ที่ 5.50 ม. ครับ
          -ระดับแม่น้ำสายสะพานมิตรภาพ แม่น้ำสายแห่งที่ 1 เกณฑ์เฝ้าระวัง อยู่ที่ 394.60 ม.รทก. ครับ
        `,
  "จะทรําบได้อย่ํางไรว่าระดับน้ำไหนอยู่ขั้นเฝ้ําระวังหรือขั้นวิกฤติ?": `
          แม่น้ำกกสะพานพ่อขุนเม็งราย:
          เฝ้าระวังที่ อยู่ที่ 5.50 ม. ครับ
          วิกฤตที่ อยู่ที่ 7.00 ม. ครับ

          แม่น้ำกกสะพานขัวพญาเม็งราย:
          เฝ้าระวังที่ อยู่ที่ 5.50 ม. ครับ
          วิกฤตที่ อยู่ที่ 6.00 ม. ครับ

          แม่น้ำสายสะพานมิตรภาพ แม่น้ำสายแห่งที่ 1:
          เฝ้าระวัง อยู่ที่ 394.60 ม.รทก. ครับ
          วิกฤต อยู่ที่ 396.59 ม.รทก. ครับ
        `,
  ...
  "มีหน่วยงานไหนช่วยเหลือได้บ้าง?": "กรมป้องกันและบรรเทาสาธารณภัย เทศบาล อบจ. อบต. อาสาสมัคร กู้ภัย ครับ",
  "แอปพลิเคชันมีกํารแจ้งเตือนอย่ํางไร?": "อปพลิเคชันจะเริ่มแจ้งเตือนเมื่อระดับน้ำถึงขั้นเฝ้าระวัง จนถึงขั้นวิกฤต ครับ",
  "แอปพลิเคชันจะมีกํารแจ้งเตือนก่อนที่น้ำจะมําไหม?": "แอปพลิเคชั่นจะเริ่มแจ้งเตือนตั้งแต่เฝ้ําระวัง ถึงขั้นวิกฤต ครับ",
  "หากต้องการทราบข่าวสารสามารถดูได้ที่ไหน?": "เพจเฟสบุ๊คน่้ำท่วมเราพร้อม หรือ ไลน์ OA น้ำท่วมเราพร้อมครับ",
  "หากต้องการรับแจ้งเตือนต้องเปิดแอปพลิเคชันไว้เสมอหรือไม่": "ไม่ต้องเปิดไว้ก็สามารถรับการแจ้งเตือนได้ครับ",
  "ศูนย์อพยพ": `
  ...
  "ระดับน้ำแถวบ้านสูงมาก แต่ยังไม่มีกำรแจ้งเตือนในแอปพลิเคชันต้องทำอย่างไร?": `
          - เก็บของขึ้นที่สูงและปิดสวิตช์ไฟฟ้าในบ้านทั้งหมด
          - เตรียมหาศูนย์อพยพ
          - ไม่ควรสัมผัสน้ำเพราะอาจมีสารปนเปื้อนครับ
        `,
  "แอปพลิเคชันมีให้แจ้งบอกข้อมูลเองไหม?": "สามารถแจ้งเข้ามาที่ต้นน้ำได้เลยครับ ต้นน้ำจะไปทำการแจ้งเตือนต่อครับ",
  ...
  "ข้อมูลในแอปนี้มาจากไหน?": "มาจาก คลังข้อมูลน้ำแห่งชาติ ส่วนอุทกวิทยาที่2 เชียงราย สำนักงานทรัพยากรน้ำที่ 1กรมทรัพยากรน้ำ และกรมอุตุนิยมวิทยาครับ",
  ...
  "คู่มือการรับมืออุทกภัย": "source={require('@/assets/images/app-icon.png')}",
